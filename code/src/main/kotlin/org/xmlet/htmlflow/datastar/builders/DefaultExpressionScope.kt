...
class DefaultExpressionScope : ExpressionScope {
    ...
    fun build() = builderExpression.joinToString("; ") { it.syntax }
    ...
    override fun toggleAll(filter: String?): DataStarAction {
